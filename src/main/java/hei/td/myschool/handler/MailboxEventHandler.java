package hei.td.myschool.handler;

import static hei.td.myschool.concurrency.ThreadRenamer.renameWorkerThread;
...
import hei.td.myschool.PojaApplication;
import hei.td.myschool.PojaGenerated;
import hei.td.myschool.endpoint.EndpointConf;
import hei.td.myschool.endpoint.event.EventConf;
import hei.td.myschool.endpoint.event.consumer.EventConsumer;
import hei.td.myschool.endpoint.event.consumer.model.ConsumableEvent;
import hei.td.myschool.endpoint.event.consumer.model.ConsumableEventTyper;
