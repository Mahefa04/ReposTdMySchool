package hei.td.myschool.endpoint.event.consumer;

import hei.td.myschool.PojaGenerated;
import hei.td.myschool.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("hei.td.myschool.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "hei.td.myschool.service.event."
