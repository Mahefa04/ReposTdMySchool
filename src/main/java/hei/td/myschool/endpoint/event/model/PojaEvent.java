package hei.td.myschool.endpoint.event.model;

import static hei.td.myschool.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import hei.td.myschool.PojaGenerated;
import hei.td.myschool.endpoint.event.EventStack;
